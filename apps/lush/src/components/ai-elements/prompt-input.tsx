...
export const PromptInputButton = ({
  ...
  useEffect(() => {
    if (tooltipOpen !== undefined) {
      setInternalTooltipOpen(tooltipOpen);
    }
  }, [tooltipOpen]);
  ...
  const handleTooltipOpenChange = useCallback(
    (nextOpen: boolean) => {
      if (tooltipOpen === undefined) {
        setInternalTooltipOpen(nextOpen);
      }
    },
    [tooltipOpen]
  );
  ...
  return (
    <Tooltip
      open={tooltipOpen ?? internalTooltipOpen}
...
const PromptInputActionMenuContext = createContext(false);
const ACTION_MENU_TOOLTIP_RELEASE_DELAY_MS = 250;
...
export const PromptInputActionMenu = ({
  ...
  const [tooltipSuppressed, setTooltipSuppressed] = useState(resolvedOpen);
  ...
  useEffect(() => {
    ...
    }, ACTION_MENU_TOOLTIP_RELEASE_DELAY_MS);
  ...
  return (
    <PromptInputActionMenuContext.Provider value={tooltipSuppressed}>
      <DropdownMenu
        open={resolvedOpen}
...
export const PromptInputActionMenuTrigger = ({
  ...
  const tooltipSuppressed = useContext(PromptInputActionMenuContext);
  ...
  return (
    <DropdownMenuTrigger asChild>
      <PromptInputButton
        className={className}
        {...props}
        tooltipOpen={tooltipSuppressed ? false : undefined}
      >
